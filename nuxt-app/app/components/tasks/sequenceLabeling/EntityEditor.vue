...
export default Vue.extend({
    ...
    computed: {
        currentLabel(): any {
            if (this.entity) {
                const label = this.entityLabels.find(
                    (label: any) => label.id === this.entity!.label,
                );
                return label;
            } else {
                return null;
        ...
        currentRelationLabel(): any {
            if (this.relation) {
                const label = this.relationLabels.find(
                    (label: any) => label.id === this.relation.labelId,
                );
                return label;
            } else {
                return null;
    ...
    methods: {
        ...
        setRelation(relationId: number) {
            this.relation = this.relations.find(
