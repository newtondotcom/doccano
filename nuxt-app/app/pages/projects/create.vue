...
const showExclusiveCategories = computed(() =>
    [DocumentClassification, ImageClassification].includes(
        editedItem.value.projectType,
    ),
);
const isSequenceLabelingProject = computed(
    () => editedItem.value.projectType === SequenceLabeling,
);
const _canDefineLabel = computed(() =>
    canDefineLabel(editedItem.value.projectType as any),
);
