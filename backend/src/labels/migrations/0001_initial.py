            ...
            state_operations=[
                ...
                migrations.AddConstraint(
                    ...
                    constraint=models.CheckConstraint(
                        condition=models.Q(("start_offset__gte", 0)),
                        name="startOffset >= 0",
                    ),
                ),
                migrations.AddConstraint(
                    model_name="span",
                    constraint=models.CheckConstraint(
                        condition=models.Q(("end_offset__gte", 0)),
                        name="endOffset >= 0",
                    ),
                ),
                migrations.AddConstraint(
                    ...
                    constraint=models.CheckConstraint(
                        condition=models.Q(
                            (
                                "start_offset__lt",
                                django.db.models.expressions.F("end_offset"),
                            )
                        ),
                        name="start < end",
                    ),
                ...
                migrations.AlterUniqueTogether(
                    name="annotationrelations",
                    unique_together={
                        ("annotation_id_1", "annotation_id_2", "type", "project")
                    },
                ),
            ],
            database_operations=[],
