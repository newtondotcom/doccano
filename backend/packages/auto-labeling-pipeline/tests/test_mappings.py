...
from auto_labeling_pipeline.mappings import (
    AmazonComprehendEntityTemplate,
    AmazonComprehendSentimentTemplate,
    AmazonRekognitionLabelDetectionTemplate,
    GCPEntitiesTemplate,
    GCPImageLabelDetectionTemplate,
    GCPSpeechToTextTemplate,
)
...
def test_gcp_entities(data_path):
    ...
    labels = labels.to_dict_list()
    expected = [
        {"label": "PERSON", "start_offset": 10, "end_offset": 15},
        {"label": "LOCATION", "start_offset": 36, "end_offset": 47},
        {"label": "LOCATION", "start_offset": 65, "end_offset": 84},
        {"label": "LOCATION", "start_offset": 86, "end_offset": 100},
        {"label": "ADDRESS", "start_offset": 60, "end_offset": 100},
        {"label": "NUMBER", "start_offset": 60, "end_offset": 64},
        {"label": "DATE", "start_offset": 105, "end_offset": 114},
        {"label": "NUMBER", "start_offset": 113, "end_offset": 114},
    ]
    assert labels == expected
...
def test_amazon_comprehend_entities(data_path):
    ...
    labels = labels.to_dict_list()
    expected = [
        {"label": "DATE", "start_offset": 14, "end_offset": 19},
        {"label": "LOCATION", "start_offset": 23, "end_offset": 30},
    ]
    assert labels == expected
