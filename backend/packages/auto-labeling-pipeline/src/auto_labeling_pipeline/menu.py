...
class Options:
    ...
    def filter_by_task(cls, task_name: str) -> List[Option]:
        ...
        return [
            ...
            if option.task == task or option.task == t.GenericTask
        ]
...
Options.register(t.GenericTask, mo.CustomRESTRequestModel, mp.MappingTemplate)
Options.register(
    t.DocumentClassification,
    mo.AmazonComprehendSentimentRequestModel,
    mp.AmazonComprehendSentimentTemplate,
)
Options.register(t.SequenceLabeling, mo.GCPEntitiesRequestModel, mp.GCPEntitiesTemplate)
Options.register(
    t.SequenceLabeling,
...
Options.register(
    t.SpeechToText, mo.GCPSpeechToTextRequestModel, mp.GCPSpeechToTextTemplate
)
