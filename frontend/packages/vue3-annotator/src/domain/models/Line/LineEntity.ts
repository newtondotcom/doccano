...
export class EntityLine {
  ...
  private createRanges(element: SVGTextElement, entity: Entity): Ranges {
    ...
    const s = Math.max(entity.startOffset, this.textLine.startOffset) - this.textLine.startOffset;
    const e = Math.min(entity.endOffset, this.textLine.endOffset) - this.textLine.startOffset;
